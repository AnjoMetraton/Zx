...
task.spawn(function()
    ...
    -- 🎨 CORES DO TEMA AVANÇADO (GLASSMORPHISM LARANJA)
    local THEME_PRIMARY = Color3.fromRGB(255, 140, 0) -- Laranja Neon
    local THEME_PRIMARY_DARK = Color3.fromRGB(204, 85, 0) -- Laranja Escuro
    ...
    -- Cores ESP
    local COLOR_LOCKED = Color3.fromRGB(255, 100, 0)  -- Laranja intenso para alvo travado
    local COLOR_VISIBLE = Color3.fromRGB(255, 140, 0) -- Laranja neon para visível
    local COLOR_HIDDEN = Color3.fromRGB(120, 50, 0)   -- Laranja escuro para oculto
    ...
    pcall(function()
        for _, v in pairs(CoreGui:GetChildren()) do
            if string.match(v.Name, "AdminNillo") or string.match(v.Name, "ComlockSilva") or string.match(v.Name, "OrangeHub") or v.Name == "Nillo_ESP" or v.Name == "Nillo_ESP2D" then v:Destroy() end
        end
    ...
    MainBtn.Text = "O"; MainBtn.Font = Enum.Font.GothamBlack; MainBtn.TextSize = 25; MainBtn.TextColor3 = THEME_PRIMARY; MainBtn.AutoButtonColor = false
    ...
    Title.Text = "Orange hub <font color='rgb(255,140,0)'>LARANJA TEMA</font>"; Title.RichText = true
    ...
    local function AddSlider(parent, text, min, max, default, callback, suffix)
        ...
        local function update(input)
            ...
            lbl.Text = text .. " <font color='rgb(255,140,0)'>" .. val .. (suffix or "") .. "</font>"
            callback(val)
        end
    ...
    task.delay(1, function()
        SendNotification("Sistema Injetado", "Interface Orange hub Ativada.\nAperte INSERT ou R-CTRL para fechar.", 5)
    end)
    ...
    print("Orange hub (Glass UI + Laranja Otimizado) carregado!")
end)
